        ...
        <table class="table table-report sm:mt-2">
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    ...
                    <td class="w-40">
                        <div class="flex">
                            <button class="custom__button w-30 text-white bg-theme-9 xl:mr-3 flex"><i data-feather="edit"></i></button>
                            <button class="custom__button w-30 text-white bg-theme-6 xl:mr-3 flex"><i data-feather="delete"></i></button>
                        </div>
                    </td>
                </tr>
