...
<div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <h2 class="intro-y text-lg font-medium mr-5 text-center">Employee Management</h2>
        <div class="intro-x text-center xl:text-left">
            <button class="custom__button w-full text-white text-center custom__bg__theme xl:mr-3 flex" type="submit"><i data-feather="plus"></i><i data-feather="users"></i></button>
        </div>
                ...
                <tr class="intro-x">
                    ...
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <button class="custom__button w-35 text-white text-center bg-theme-1 xl:mr-3 flex"><i data-feather="upload"></i></button>
                        </div>
                    </td>
                    <td class="w-40">
                        <div class="flex">
                    ...
                    <td class="w-40">
                        <div class="flex">
                            <button class="custom__button w-35 text-white custom__bg__theme xl:mr-3 flex"><i data-feather="eye"></i></button>
                            <button class="custom__button w-35 text-white bg-theme-9 xl:mr-3 flex"><i data-feather="edit"></i></button>
                            <button class="custom__button w-35 text-white bg-theme-6 xl:mr-3 flex"><i data-feather="delete"></i></button>
                        </div>
                    </td>
                </tr>
