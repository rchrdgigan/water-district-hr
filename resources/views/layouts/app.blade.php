...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-blue shadow-sm">
            <div class="container">
                <img src="{{asset('img/waterdistrict_logo.png')}}" class="rounded-pill" width="35" alt="Logo">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end hover_custom" aria-labelledby="navbarDropdown">
